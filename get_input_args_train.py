...
def get_input_args_train():
	...
	parser.add_argument('data_directory', action='store', help='Directory of images to train on')
	...
	parser.add_argument('--save_dir', nargs=1, default='./', help='Directory to save checkpoints in with default ./')
